...
func NewKubernetes(framework *framework.Framework, clientSet clientset.Interface) *Kubernetes {
	return &Kubernetes{
		mutex:     &sync.Mutex{},
		podCache:  map[string][]v1.Pod{},
		framework: framework,
...
func (k *Kubernetes) ExecuteRemoteCommand(pod v1.Pod, containerName string, command []string) (string, string, error) {
