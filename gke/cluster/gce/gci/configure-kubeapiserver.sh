...
function start-kube-apiserver {
  ...
  # The env variable was renamed from GKEAUTOPILOT_SPECIALWEBHOOKS_CONFIG_YAML to
  # GKEWARDEN_SPECIALWEBHOOKS_CONFIG_YAML in GCW targetting 1.26+, so only
  # GKEWARDEN_SPECIALWEBHOOKS_CONFIG_YAML needs to be considered in 1.27+.
...
EOF
  ...
  # variable was renamed from GKEAUTOPILOT_AUTHZ_KUBECONFIG to
  # GKEWARDEN_AUTHZ_KUBECONFIG for GCW components targetting 1.26+, so only
  # GKEWARDEN_AUTHZ_KUBECONFIG needs to be considered for 1.27+.
